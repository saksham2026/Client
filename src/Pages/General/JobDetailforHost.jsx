...
function JobDetailforHost() {
  ...
  async function getRole() {
    Axios("https://retrocraft-backend.onrender.com/api/v1/user/getrole", {
      jobId,
    }).then((response) => {
  ...
  async function getJob() {
    setLoading(true);
    Axios("https://retrocraft-backend.onrender.com/api/v1/user/getjobdetail", {
      jobId,
    })
      .then((response) => {
  ...
  return (
    <>
      ...
      <div className="overflow-x-hidden h-screen w-screen bg-black flex flex-col gap-10 items-center">
        ...
        <div
          id="host-information"
          className="w-full h-[300px] flex items-center justify-center border bg-black"
        ></div>
        <h1 className="text-white font-bold text-4xl">Job Poster</h1>
        <div className="h-[200px] w-[200px] bg-white rounded-md text-black flex flex-col items-center gap-7">
