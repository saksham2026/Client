...
function FreelancerDashboard() {
  ...
  async function getProducersAndFreelancers() {
    Axios("http://localhost:7777/api/v1/user/getproducersandfreelancers", {
  ...
  async function getAllJobs() {
    Axios("http://localhost:7777/api/v1/user/getalljobs")
      .then((response) => {
    ...
    <>
      ...
      <div className="bg-black h-screen w-screen text-white flex flex-col items-center gap-8 overflow-y-scoll overflow-x-hidden pb-5">
        ...
        <div className="flex flex-col items-center gap-5 w-full">
          <h1 className="font-bold text-4xl">New Jobs</h1>
          <div
